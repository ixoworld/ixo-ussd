 ...
 * - Session ID: rec-02-create-account-skip-email-1774620304055-4
 * - Phone: +260971230001
 * - Service Code: *2233#
 * - Recorded: 2026-03-27T14:05:08.586Z
 * - Turns: 9
 *
 * Run with:
...
describe("02-create-account-skip-email - USSD Flow Test", () => {
  ...
  it('Turn 6: Input: "43219"', async () => {
    ...
    // Cumulative USSD text: "2*2*Jane Smith*00*43219"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Jane Smith*00*43219");
  ...
  it('Turn 7: Input: "43219"', async () => {
    ...
    // Cumulative USSD text: "2*2*Jane Smith*00*43219*43219"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Jane Smith*00*43219*43219");
  ...
  it('Turn 8: Input: "1"', async () => {
    ...
    // Cumulative USSD text: "2*2*Jane Smith*00*43219*43219*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Jane Smith*00*43219*43219*1");
  ...
  it('Turn 9: Input: "1"', async () => {
    ...
    // Cumulative USSD text: "2*2*Jane Smith*00*43219*43219*1*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Jane Smith*00*43219*43219*1*1");
