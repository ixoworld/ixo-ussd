/**
 * Generated Test: 04-exit-from-any-menu
 *
 * This test was automatically generated from a recorded USSD session.
 *
 * Session Details:
 * - Flow: 04-exit-from-any-menu
 * - Session ID: rec-04-exit-from-any-menu-1774620330803-10
 * - Phone: +260971230001
 * - Service Code: *2233#
 * - Recorded: 2026-03-27T14:05:32.820Z
 * - Turns: 4
 *
 * Run with:
...
const SESSION_ID = `flow-test-04-exit-from-any-menu-${Date.now()}-${Math.random().toString(36).substring(2, 9)}`;
...
describe("04-exit-from-any-menu - USSD Flow Test", () => {
  beforeAll(async () => {
