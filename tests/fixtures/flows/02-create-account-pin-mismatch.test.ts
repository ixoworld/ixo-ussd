/**
 * Generated Test: 02-create-account-pin-mismatch
 *
 * This test was automatically generated from a recorded USSD session.
 *
 * Session Details:
 * - Flow: 02-create-account-pin-mismatch
 * - Session ID: rec-02-create-account-pin-mismatch-1774620313115-6
 * - Phone: +260971230001
 * - Service Code: *2233#
 * - Recorded: 2026-03-27T14:05:18.657Z
 * - Turns: 11
 *
 * Run with:
...
const SESSION_ID = `flow-test-02-create-account-pin-mismatch-${Date.now()}-${Math.random().toString(36).substring(2, 9)}`;
...
describe("02-create-account-pin-mismatch - USSD Flow Test", () => {
  beforeAll(async () => {
  ...
  it('Turn 4: Input: "Charlie Davis"', async () => {
    // Simulate realistic user interaction timing (2-second delay)
    await new Promise(resolve => setTimeout(resolve, 2000));

    // Cumulative USSD text: "2*2*Charlie Davis"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Charlie Davis");
  ...
  it('Turn 5: Input: "00"', async () => {
    ...
    // Cumulative USSD text: "2*2*Charlie Davis*00"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Charlie Davis*00");
  ...
  it('Turn 6: Input: "43219"', async () => {
    ...
    // Cumulative USSD text: "2*2*Charlie Davis*00*43219"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Charlie Davis*00*43219");
  ...
  it('Turn 7: Input: "99999"', async () => {
    // Simulate realistic user interaction timing (2-second delay)
    await new Promise(resolve => setTimeout(resolve, 2000));

    // Cumulative USSD text: "2*2*Charlie Davis*00*43219*99999"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Charlie Davis*00*43219*99999");
  ...
  it('Turn 8: Input: "43219"', async () => {
    // Simulate realistic user interaction timing (2-second delay)
    await new Promise(resolve => setTimeout(resolve, 2000));

    // Cumulative USSD text: "2*2*Charlie Davis*00*43219*99999*43219"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest(
      "2*2*Charlie Davis*00*43219*99999*43219"
    );
  ...
  it('Turn 9: Input: "43219"', async () => {
    // Simulate realistic user interaction timing (2-second delay)
    await new Promise(resolve => setTimeout(resolve, 2000));

    // Cumulative USSD text: "2*2*Charlie Davis*00*43219*99999*43219*43219"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest(
      "2*2*Charlie Davis*00*43219*99999*43219*43219"
    );
  ...
  it('Turn 10: Input: "1"', async () => {
    ...
    // Cumulative USSD text: "2*2*Charlie Davis*00*43219*99999*43219*43219*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest(
      "2*2*Charlie Davis*00*43219*99999*43219*43219*1"
    );
  ...
  it('Turn 11: Input: "1"', async () => {
    ...
    // Cumulative USSD text: "2*2*Charlie Davis*00*43219*99999*43219*43219*1*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest(
      "2*2*Charlie Davis*00*43219*99999*43219*43219*1*1"
    );
