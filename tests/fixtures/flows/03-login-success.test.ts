/**
 * Generated Test: 03-login-success
 *
 * This test was automatically generated from a recorded USSD session.
 *
 * Session Details:
 * - Flow: 03-login-success
 * - Session ID: rec-03-login-success-1774620318699-7
 * - Phone: +260971230001
 * - Service Code: *2233#
 * - Recorded: 2026-03-27T14:05:23.235Z
 * - Turns: 9
 *
 * Run with:
...
const SESSION_ID = `flow-test-03-login-success-${Date.now()}-${Math.random().toString(36).substring(2, 9)}`;
...
describe("03-login-success - USSD Flow Test", () => {
  beforeAll(async () => {
  ...
  it('Turn 6: Input: "43219"', async () => {
    ...
    // Cumulative USSD text: "2*1*CE3D5D483*1*43219"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest(`2*1*${CUSTOMER_ID}*1*43219`);
  ...
  it('Turn 7: Input: "1"', async () => {
    ...
    // Cumulative USSD text: "2*1*CE3D5D483*1*43219*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest(`2*1*${CUSTOMER_ID}*1*43219*1`);
  ...
  it('Turn 8: Input: "1"', async () => {
    ...
    // Cumulative USSD text: "2*1*CE3D5D483*1*43219*1*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest(`2*1*${CUSTOMER_ID}*1*43219*1*1`);
  ...
  it('Turn 9: Input: "1"', async () => {
    ...
    // Cumulative USSD text: "2*1*CE3D5D483*1*43219*1*1*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest(`2*1*${CUSTOMER_ID}*1*43219*1*1*1`);
