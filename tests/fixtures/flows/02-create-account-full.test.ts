/**
 * Generated Test: 02-create-account-full
 *
 * This test was automatically generated from a recorded USSD session.
 *
 * Session Details:
 * - Flow: 02-create-account-full
 * - Session ID: rec-02-create-account-full-1774620299516-3
 * - Phone: +260971230001
 * - Service Code: *2233#
 * - Recorded: 2026-03-27T14:05:04.055Z
 * - Turns: 9
 *
 * Run with:
...
const SESSION_ID = `flow-test-02-create-account-full-${Date.now()}-${Math.random().toString(36).substring(2, 9)}`;
...
describe("02-create-account-full - USSD Flow Test", () => {
  beforeAll(async () => {
  ...
  it('Turn 4: Input: "John Doe"', async () => {
    // Simulate realistic user interaction timing (2-second delay)
    await new Promise(resolve => setTimeout(resolve, 2000));

    // Cumulative USSD text: "2*2*John Doe"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*John Doe");
  ...
  it('Turn 5: Input: "john@test.com"', async () => {
    // Simulate realistic user interaction timing (2-second delay)
    await new Promise(resolve => setTimeout(resolve, 2000));

    // Cumulative USSD text: "2*2*John Doe*john@test.com"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*John Doe*john@test.com");
  ...
  it('Turn 6: Input: "43219"', async () => {
    ...
    // Cumulative USSD text: "2*2*John Doe*john@test.com*43219"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*John Doe*john@test.com*43219");
  ...
  it('Turn 7: Input: "43219"', async () => {
    ...
    // Cumulative USSD text: "2*2*John Doe*john@test.com*43219*43219"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest(
      "2*2*John Doe*john@test.com*43219*43219"
    );
  ...
  it('Turn 8: Input: "1"', async () => {
    ...
    // Cumulative USSD text: "2*2*John Doe*john@test.com*43219*43219*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest(
      "2*2*John Doe*john@test.com*43219*43219*1"
    );
  ...
  it('Turn 9: Input: "1"', async () => {
    ...
    // Cumulative USSD text: "2*2*John Doe*john@test.com*43219*43219*1*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest(
      "2*2*John Doe*john@test.com*43219*43219*1*1"
    );
