/**
 * Generated Test: 04-back-navigation-chain
 *
 * This test was automatically generated from a recorded USSD session.
 *
 * Session Details:
 * - Flow: 04-back-navigation-chain
 * - Session ID: rec-04-back-navigation-chain-1774620332820-11
 * - Phone: +260971230001
 * - Service Code: *2233#
 * - Recorded: 2026-03-27T14:05:38.357Z
 * - Turns: 11
 *
 * Run with:
...
const SESSION_ID = `flow-test-04-back-navigation-chain-${Date.now()}-${Math.random().toString(36).substring(2, 9)}`;
...
describe("04-back-navigation-chain - USSD Flow Test", () => {
  beforeAll(async () => {
